...
def run_test_sum_more_cosines():
    ...
    expected = -.3953251795  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(-2, 4)
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = -2.059782954  # This is APPROXIMATELY the correct answer.
...
def sum_more_cosines(m, n):
    ...
    # ------------------------------------------------------------------
    # This was my original atempt. This had issues with negative numbers
    # sum_m_cos = 0
    # sum_m_cos2 = 0
    # if m >= 0:
    #     for k in range(m):
    #         sum_m_cos = sum_m_cos + math.cos(k)
    #         print(sum_m_cos)
    #     for k in range(n+1):
    #         sum_m_cos2 = sum_m_cos2 + math.cos(k)
    #         print(sum_m_cos2)
    #     return(sum_m_cos2-sum_m_cos)
    # else:
    #     for k in range(-m+1):
    #         sum_m_cos = sum_m_cos + math.cos(k)
    #         print(sum_m_cos)
    ...
    #         sum_m_cos2 = sum_m_cos2 + math.cos(k)
    #         print(sum_m_cos2)
    #     return(sum_m_cos2+sum_m_cos-math.cos(0))
    sum_m_cos = 0
    for k in range(n-m+1):
        sum_m_cos = sum_m_cos + math.cos(m+k)
        # print(sum_m_cos) for checking
    return sum_m_cos
